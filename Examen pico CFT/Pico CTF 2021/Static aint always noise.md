...
└─$ ls
 flag                          static
 ltdis.sh                     'Static aint always noise.md'
'Magikarp Ground Mission.md'  'Tab, Tab, Attack.md'
'Nice netcat.md'               warm
'Obedient Cat.md'             'Wave a flag.md'
 pw.txt
...
┌──(espasandia24㉿kali)-[~/Escritorio/HakinKali/Examen pico CFT/Pico CTF 2021]                                                                            
└─$ ls
 flag                         'Static aint always noise.md'
 ltdis.sh                      static.ltdis.strings.txt
'Magikarp Ground Mission.md'   static.ltdis.x86_64.txt
'Nice netcat.md'              'Tab, Tab, Attack.md'
'Obedient Cat.md'              warm
 pw.txt                       'Wave a flag.md'
 static
